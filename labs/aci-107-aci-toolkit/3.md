...
![Figure](/posts/files/aci-107-aci-toolkit/tenentsbefore.png)
...
![Figure](/posts/files/aci-107-aci-toolkit/appprofile.png)

Also created under Networking are a Context of ``myvrf`` and a BridgeDomain of ``BD-mybd``:

![Figure](/posts/files/aci-107-aci-toolkit/networking.png)
